...
func TestParseBeadsVersion(t *testing.T) {
	tests := []struct {
		...
		{`{"data":{"version":"1.0.4"},"version":"1.0.5"}`, ""},
		...
		{"warning: invalid JSON follows\n" + `{"data":{"build":"bd version 9.9.9","version":"1.0.3"}}`, ""},
		{"\ufeff" + `{"data":{"build":"bd version 9.9.9","version":"1.0.3"}}`, ""},
		{"\x1b[31m" + `{"data":{"build":"bd version 9.9.9","version":"1.0.3"}}`, ""},
...
func TestCheckBeadsEnforcesReasonFileVersionFloor(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{output: `{"data":{"version":"1.0.4"},"version":"1.0.5"}`, version: "", status: BeadsUnknown},
		...
		{output: "warning: invalid JSON follows\n" + `{"data":{"build":"bd version 9.9.9","version":"1.0.3"}}`, version: "", status: BeadsUnknown},
		{output: "\ufeff" + `{"data":{"build":"bd version 9.9.9","version":"1.0.3"}}`, version: "", status: BeadsUnknown},
	} {
