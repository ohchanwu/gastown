...
func TestParseBeadsVersion(t *testing.T) {
	tests := []struct {
		...
		{`{"schema_version":1,"version":"1.0.3","version":"1.0.5"}`, ""},
		{`{"data":{"version":"1.0.3","version":"1.0.5"},"schema_version":1}`, ""},
		{`{"data":{"version":"1.0.3"},"data":{"version":"1.0.5"},"schema_version":1}`, ""},
		{`{"schema_version":1,"schema_version":1,"version":"1.0.5"}`, ""},
...
func TestCheckBeadsEnforcesReasonFileVersionFloor(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{output: `{"schema_version":1,"version":"1.0.3","version":"1.0.5"}`, version: "", status: BeadsUnknown},
		{output: `{"data":{"version":"1.0.3","version":"1.0.5"},"schema_version":1}`, version: "", status: BeadsUnknown},
		{output: `{"schema_version":1,"schema_version":1,"version":"1.0.5"}`, version: "", status: BeadsUnknown},
